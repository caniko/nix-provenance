...
Do not add app-local password, PIN, password-reset, or notification-email provisioning to service-side modules such as Immich, Vikunja, Forgejo, or Stalwart unless this repository's identity model is explicitly changed first.
