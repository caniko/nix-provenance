...
| `nix/lib/immich.nix`, `nix/modules/service-oidc/immich.nix`, `nix/modules/test/immich-eval.nix`, `docs/rfcs/**`, `docs/kanidm-oidc-migration.md` | `AGPL-3.0-only` | immich-provision |
| `nix/lib/rauthy.nix`, `nix/modules/idp/rauthy.nix` | `MIT OR Apache-2.0` | rauthy-provision |
| everything else (`flake.nix`, `nix/lib/default.nix`, `nix/packages.nix`, `nix/checks.nix`, root files, `docs/architecture.md`) | `MIT OR Apache-2.0` | nix-provenance |
